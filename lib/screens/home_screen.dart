...
import 'package:technocore_template_v1/data/models/category.dart';
...
import 'package:technocore_template_v1/providers/cart_provider.dart';
import 'package:technocore_template_v1/screens/brand_product_screen.dart';
import 'package:technocore_template_v1/screens/categories_screen.dart';
import 'package:technocore_template_v1/screens/product_details.dart';
import 'package:technocore_template_v1/widgets/brandItem.dart';
import 'package:technocore_template_v1/widgets/custom_button.dart';
import 'package:technocore_template_v1/widgets/footer_widget.dart';
    ...
    child: Row(
      children: [
        ...
        if (onTap != null)
          TextButton(
            onPressed: onTap,
            child: Text('عرض الكل', style: TextStyle(color: Colors.deepOrange.shade300)),
          ),
      ],
    ),
  );
          ...
          title: Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                const CircleAvatar(
                  backgroundImage: AssetImage('assets/sham_logo.png'),
                ),
              ],
            ),
          ),
